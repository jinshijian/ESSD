...
ggsave('outputs_collar/Figure2.TestCollarDepth.jpg', width = 8, height = 7)
```

```{r test chamber area}
time_depth_test (srdbv5, Chamber_area, 4000)
ggsave('outputs_collar/Figure3.TestChamberArea.jpg', width = 6, height = 4)
```


```{r test measure interval}
time_depth_test (srdbv5, Meas_interval, 150)
# ggsave('outputs_collar/Figure4.TestMeasureInterval.jpg', width = 6, height = 4)
```
...
srdbv5 %>% 
  ...
  labs(size="obs (n)")
ggsave('outputs_collar/Figure4.TestMeasureInterval.jpg', width = 6, height = 7)
```
...
ggsave('outputs_collar/Figure5.TestHoursCovered.jpg', width = 6, height = 4)
```
